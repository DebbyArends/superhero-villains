...
function Powerstats() {
    ...
    //     if (questionsPower[currentQuestion].questionText === 'What is your knowledge?'){
    //         return (
    //             setIntelligence(e.target.value),
    //                 setRadioCheck(false)
    //         )
    //     }
    //     else if (questionsPower[currentQuestion].questionText === 'How strong are you?'){
    //         return (
    //             setStrength(e.target.value),
    //                 setRadioCheck(false)
    //         )
    //     }
    //     else if (questionsPower[currentQuestion].questionText === 'How fast are you?'){
    //         return (
    //             setSpeed(e.target.value),
    //                 setRadioCheck(false)
    //         )
    //     }
    //     else if (questionsPower[currentQuestion].questionText === 'How are your fighting skills?'){
    //         return (
    //             setCombat(e.target.value),
    //                 setRadioCheck(false)
    //         )
    //     }
    //     else if (questionsPower[currentQuestion].questionText === 'How long would you last in a fight'){
    //         return (
    //             setCombat(e.target.value),
    //                 setRadioCheck(false)
    //         )
    ...
    function getQuestions(){
        ...
        if (questionsPower[currentQuestion].questionText === "How strong are you?") {
            return(
    ...
    function handleAnswerInput() {
        if (currentQuestion + 1 < questionsPower.length) {
            ...
            // setRadioCheck(true)
            console.log(intelligence,strength, speed, combat,durability);
        }
        else{
            setShowResult(intelligence,strength, speed, combat,durability)
        }
    }
    ...
    // function getClosestintelligence() {
    //     let goal = parseInt(intelligence, 10)
    //
    //     let closest = character.reduce(function(prev, curr) {
    //         return (Math.abs(curr - goal) < Math.abs(prev - goal) ? curr : prev);
    //     });
    //
    //     return(
    //         // closest,
    //         console.log( closest, goal)
    //     )
    // }
    //
    // console.log(getClosestintelligence());

    const filterStats5 = character.filter((character) => {
        return (
            character.powerstats.intelligence === parseInt(intelligence, 10)
            && character.powerstats.strength === parseInt(strength, 10)
            && character.powerstats.speed === parseInt(speed, 10)
            && character.powerstats.combat === parseInt(combat, 10)
            && character.powerstats.durability === parseInt(durability, 10)
        )
    })

    console.log(filterStats5);

    const filterIntelligence = character.filter((character) => {
        return (character.powerstats.intelligence === parseInt(intelligence, 10))
    })

    const filterStrength = character.filter((character) => {
        return (character.powerstats.strength === parseInt(strength, 10))
    })

    const filterSpeed = character.filter((character) => {
        return (character.powerstats.speed === parseInt(speed, 10))
    })

    const filterCombat = character.filter((character) => {
        return (character.powerstats.combat === parseInt(combat, 10))
    })

    const filterDurability = character.filter((character) => {
        return (character.powerstats.durability === parseInt(durability, 10))
    })


    console.log(filterIntelligence,filterStrength,filterSpeed,filterCombat,filterDurability);


    let find1Power = character.find(() => {
        return (filterIntelligence === filterStrength)
    })

    console.log(find1Power)
    ...
    // let find1Power = filter1.find((character) => {
